    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('blog.update', ['blog'=> $post->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('body') is-invalid @enderror" id="body" name='body' rows="3" required>{{ $post->body }}</textarea>
